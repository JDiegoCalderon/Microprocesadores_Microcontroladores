; Program for operating two external interrupts
LIST P = 18f45K50
...
ORG 1008h		; Loads the following instruction at address 000008h
GOTO InterH
ORG 1018h		; Loads the following instruction at address 000018h
GOTO InterL
